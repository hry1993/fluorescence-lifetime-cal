...
right = 400 # above this will be shown as red, right should larger than left

img = []
result = []
size = 1024

countL = 120 # smallest value
distance = 10 # range between two value
countN = 9 # number of intervals
count = []
countV = []
number = 0
